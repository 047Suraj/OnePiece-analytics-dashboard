...
🎯 Objectives
Design a relational database structure from scratch with 8 interconnected tables
...
Characters
37
All major characters with Devil Fruit & Haki data
Bounties
32
Bounty progression over time per character
Episodes
40
Key episodes with IMDb ratings & filler tags
Arcs
22
All arcs with episode count & avg ratings
Pirate Crews
15
Major crews with combined bounty & status
World Gov & Marines
20
Officials with ranks & Devil Fruit info
Fights / Battles
22
Major battles with winners & techniques used
IMU & Power Structure
15
...
Details
Data Collection
Manual research + structured dataset creation
Data Cleaning
Excel — standardization, null handling, data types
Data Modeling
Power BI — star schema, relationships, foreign keys
DAX Measures
Filler %, DF Users count, Haki Users count, Avg Rating
Visualization
Power BI — Bar, Line, Donut, Card, Table, Slicer
Design
Custom One Piece theme — Black + Red + Gold color palette
🔗 Data Model Relationships
Code
💡 Key Insights
Wano Country Arc has the highest episode count (149) and one of the highest avg ratings (9.0)
Marineford Arc remains the most emotionally impactful — highest peak rating episode (9.6)
Filler episodes account for ~7.5% of total episodes — lower than most long-running anime
...
End-to-end analytics dashboard built using Power BI, Excel, and data modeling.

## Dashboard Screenshots

### World Overview Dashboard
![World Overview](dashboard-page%201.png)

### Character & Power Analysis
![Character & Power Analysis](dashboard-page2.png)

### Faction & Battle Intelligence
![Faction & Battle Intelligence](dashboard-page%203.png)
